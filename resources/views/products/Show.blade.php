<x-app-layout>
    ...
    <div class="md:flex md:items-center">
        <div class="w-full h-64 md:w-1/2 lg:h-96">
            <img class="h-full w-full rounded-md object-cover max-w-lg mx-auto" src="/image/{{$product->image}}" alt="Nike Air">
        </div>
        <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
            <h3 class="text-gray-700 uppercase text-lg">{{'Price'}}</h3>
            <span class="text-gray-500 mt-3">{{$product->price}}{{$currency}}</span>
            <hr class="my-3">
            <div class="mt-2">
            <h3 class="text-gray-700 uppercase text-lg">{{'Stock'}}</h3>
            <span class="text-gray-500 mt-3">{{$product->stock}}</span>
            </div>
            <hr class="my-3">
            <div class="mt-2">
               <div class="mt-2">
                ...
                <div class="mt-2">
                    <h3 class="text-gray-700 uppercase text-lg">{{'Status'}}</h3>
                    <span class="text-gray-500 mt-3">{{'Product active'}}</span>
                </div>
                <hr class="my-3">
                @else
                    <div class="mt-2">
                        <h3 class="text-gray-700 uppercase text-lg">{{'Status'}}</h3>
                        <span class="text-gray-500 mt-3">{{$product->disabled_at}}</span>
                    </div>
                    <hr class="my-3">
                @endif
            ...
            <div class="flex items-center mt-6">
                <button class="px-8 py-2 bg-indigo-600 text-white text-sm font-medium rounded hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500">Volver a la tabla</button>
