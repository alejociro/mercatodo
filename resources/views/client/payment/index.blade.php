                                                ...
                                                <form method="POST" action="{{route('trypayment', $payment)}}}">
                                                    ...
                                                    <div class="inline-flex p-2">
                                                        <button
                                                            ...
                                                            <span class="ml-2 mt-5px">try payment</span>
                                                        </button>
                                                    </div>
                                                </form>
                                            @endif
                                            @if($payment->status === 'pending')
                                                <div class="inline-flex p-2">
                                                    <a href="{{$payment->process_url}}"
                                                       class="inline-flex items-center bg-white leading-none text-green-600 rounded-full p-2 shadow text-teal text-sm">Continuar
                                                        con el pago</a>
                                                </div>
                                            @endif
                                        </td>
