                ...
                <div class="my-4 mt-6 -mx-2 lg:flex">
                    <div class="lg:px-2 lg:w-1/2">
                        <div class="p-4 bg-gray-100 rounded-full">
                            <h1 class="ml-2 font-bold uppercase">{{trans('Status transfer')}}</h1>
                        </div>
                        <div class="p-4">
                            <p class="mb-4 italic">{{trans('The status of your transfer is')}}</p>
                                ...
                                <form action="" method="POST">
                                    <div
                                        ...
                                        <div class="p-4 bg-green-400 rounded-full">
                                            <h1 class="ml-2 font-bold uppercase">{{trans('successful')}}</h1>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="p-4">
                            ...
                            <a href="{{route('payments.index')}}"
                               class="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-blue-300 rounded-full shadow item-center hover:bg-blue-700 focus:shadow-outline focus:outline-none">
                                ...
                                <span class="ml-2 mt-5px">{{trans('Back to payments')}}</span>
                            </a>
                        </div>
                    </div>
                </div>
