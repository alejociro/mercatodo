        ...
        <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5">
            <div class="flex-1">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    ...
                                    <form action="{{route('shoppingCartItems.destroy',$product)}}" method="POST">
                                        @csrf
                                        @method('delete')
                            ...
                            <td class="justify-center md:justify-end md:flex mt-6">
                                ...
                                <form method="POST" action="{{ route('shoppingCarts.items.update', ['product'=>$product->product,]) }}">
                                    @csrf
                                    <div class="w-20 h-10">
                                        <div class="relative flex flex-row w-full h-8">
                                            <input id="quantity" class="block mt-1 w-full" type="number" min="1"
              ...
              <span class="text-sm lg:text-base font-medium">
                {{$product->product->price_format}}{{$currency}}
              </span>
                            </td>
                            <td class="text-right">
              <span class="text-sm lg:text-base font-medium">
